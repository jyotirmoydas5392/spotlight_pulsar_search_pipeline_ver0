...
# Script to make ps/png files for GHRSS (GMRT) candidates 
         ...
         set outdir=`/home/bhaswati/GHRSS_cands_6may/plot_files`
cp cand_file /home/bhaswati/GHRSS_cands_6may/plot_files
cd /home/bhaswati/GHRSS_cands_6may/plot_files
@ i = 1
while ($i <= $numfile)
