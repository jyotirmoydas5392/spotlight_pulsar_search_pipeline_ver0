...
# Script to make ps/png files for GHRSS (GMRT) candidates 
         ...
         set outdir=`/home/bhaswati/Machine_Learning/30apr2k15/plot_files`
mkdir plot_files
cp cand_file /home/bhaswati/Machine_Learning/30apr2k15/plot_files
cd /home/bhaswati/Machine_Learning/30apr2k15/plot_files
@ i = 1
while ($i <= $numfile)
